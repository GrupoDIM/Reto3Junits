...
public class Cliente implements Serializable {
	...
	public Cliente(int id, String dni, String nombre, String apellido1, String apellido2, String email, String tele,
			String password, char genero, List<Factura> tickets) {
		super();
		this.id = id;
		this.dni = dni;
		this.nombre = nombre;
